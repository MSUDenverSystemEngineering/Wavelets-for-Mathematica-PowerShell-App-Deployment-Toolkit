...
Try {
	...
	[string]$appVendor = ''
	[string]$appName = 'Wavelets for Mathematica'
	[string]$appVersion = ''
	[string]$appArch = ''
	[string]$appLang = 'EN'
	[string]$appRevision = '01'
	[string]$appScriptVersion = '1.0.0'
	[string]$appScriptDate = '01/10/2017'
	...
	If ($deploymentType -ine 'Uninstall') {
		...
		## Show Welcome Message, close Mathematica , verify there is enough disk space to complete the install, and persist the prompt
		...
		Copy-File -Path "$dirFiles\DiscreteWavelets\*" -Destination "$envProgramData\Mathematica\Applications\DiscreteWavelets" -Recurse
		Copy-File -Path "$dirFiles\WaveletWare\*" -Destination "$envProgramData\Mathematica\Applications\WaveletWare" -Recurse
	...
	ElseIf ($deploymentType -ieq 'Uninstall')
	{
		...
		Remove-File -Path "$envProgramData\Mathematica\Applications\WaveletWare" -Recurse
		Remove-File -Path "$envProgramData\Mathematica\Applications\DiscreteWavelets" -Recurse
...
# KX7zUQIBAAIBAAIBAAIBAAIBADAxMA0GCWCGSAFlAwQCAQUABCAYiJS9b7cZEnIC
# eu49LazetK+Rx/89EQp4x1xZjGtyr6CCD4cwggQUMIIC/KADAgECAgsEAAAAAAEv
...
# gAAwGQYJKoZIhvcNAQkDMQwGCisGAQQBgjcCAQQwLwYJKoZIhvcNAQkEMSIEIMoj
# V3TNM92KUQRQHhu3wu4dIUqv/RcUQl0+JQgczg7wMA0GCSqGSIb3DQEBAQUABIIB
# AKZ1MtQfd0Mg98gPm3s5Y82T2y7lEKysrQoO+BZ9Qrb6wRug2Bc1jrYuaPrHvhGk
# 5EgrIrrZqjhwrccejjVrij9jdG9UU3WQxUSmHJQgJL+K/INVvF/WGZJJzAhOjQTR
# c9gaCeBSNzMLO0478s0OJ/u1CnvzpiIN4Oo6/hLYiYHLUGJ++TWsQuNlc7nPZ8pg
# 3R0sExn37w0FJjiv4jJHYzP1UF8il+75thelQ8UYh+x6MfcyZSxOiuU3gTVTLeyT
# lkhp8Y2T6RLpK47HPpHw2oA8cUiAHm6Md8+8r65c2LTCsxnSBO1A8H0ijKtWhihX
# fBBVMmitdCeSYXTCb/Mi812hggKiMIICngYJKoZIhvcNAQkGMYICjzCCAosCAQEw
...
# ATAcBgkqhkiG9w0BCQUxDxcNMTcwMTEwMjEyMzIzWjAjBgkqhkiG9w0BCQQxFgQU
# 2vhHK/GempXXdVh8eyo161PfVZcwgZ0GCyqGSIb3DQEJEAIMMYGNMIGKMIGHMIGE
...
# AQUABIIBAI0iwi9H0NHZ1117+608TpdLore3iqA1/OCDdormhVGzUcoNEmK6wJiS
# hF3lyy+1eer3sTSFKQe3rbu2pWhLmWcAuC+yr1Ldly2unureoWc4BW+mKGnq+9tW
# lgtjGeCdWgYBHgWAf9cAIJSB9ONpKpEyzY+bB1eqDD1hdTLHRgoF2RK/1Qb/0XAG
# tbIIbQENtw/NfWrL7IWZJ9N9b0qmt148nuE22RHrmEcE1tS8WNxntEFQabG45AAO
# OegrgeEmrQAN0TsNK/wtHHitTi0VeCeP43yS2s7V9+qIGd2HK0aM6/LKHTczaIyk
# 2dtg2EvwNtrZZD7l2DbGQd11Pr70dk4=
